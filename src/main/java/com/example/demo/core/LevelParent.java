...
public abstract class LevelParent {
	...
	public LevelParent(String backgroundImageName,double screenHeight, double screenWidth, int playerInitialHealth) {
		...
		ImageView background=new ImageView(backgroundImageName);
		UserPlane user= new UserPlane(playerInitialHealth);
		LevelView levelView=instantiateLevelView();

		this.actorManager=new ActorManager(user,root);
		this.uiManager=new UIManager(root,background,user,levelView);
		this.inputHandler=new InputHandler(user);
		this.gameManager=new GameManager(actorManager,uiManager,this::handleLevelEvent);
	...
	private void handleLevelEvent (String event) {
