...
/**
 * level 3 of the game
 * --> initialises player's plane, spawns 3 miniboss, checks game-over conditions
 */
public class LevelThree extends AbstractLevel {
    private final LevelConfig config;

    /**
     * constructs a {@code LevelThree} instance with specified screen dimensions
     ...
     * 2) if the user has reached the kill target (has killed all 3 minibosses)
     *  --> game is won
     */
    @Override
