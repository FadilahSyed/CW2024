...
/**
 * level 2 of the game
 * --> initialises player's plane, spawns enemy2plane, checks game-over conditions
 */
public class LevelTwo extends AbstractLevel {
    private final LevelConfig config;

    /**
     * constructs a {@code LevelTwo} instance with specified screen dimensions
     * introduces level configurations
